...
async function processAction(msg, cfg)
{
    ...
    async function addContact(postRequestBody, meta)
    {
        ...
        if('recordUid' in meta) {
          ...
          if(existent !== false) console.log('Found record via recordUid');
        }
    ...
    await addContact(transformedData, msg.metadata);
    emitData({ data: transformedData, metadata: msg.metadata });
